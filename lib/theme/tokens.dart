...
abstract final class AppColors {
  ...
  /// Заглиблення: плита під цифровим падом. Єдиний рівень НИЖЧЕ фону —
  /// на OLED «тінь» малюється темнішим фоном, а не чорним розмиттям,
  /// бо чорне на майже-чорному невидиме.
  static const bgWell = Color(0xFF070809);
