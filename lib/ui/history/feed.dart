...
class _EdgeVanish extends StatelessWidget {
  ...
  ///
  /// Калібрування (рішення 52): у спокої центр першого рядка стоїть на
  /// 24 (відступ) + 46 (заголовок) + 28 (піврядка) = 98dp, тож зона 56
  /// (поріг 46+56=102) тримала його ледь усередині — t≈0.93, слабкий
  /// блюр у спокої. 48 дає поріг 94 і запас 4dp.
  static const _zone = 48.0;
