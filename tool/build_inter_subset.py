...
**Вихідні шрифти лежать у `tool/inter-src/` і тримаються в репозиторії.**
На відміну від Noto (2.9 МБ) вони важать разом ~2 МБ, і тримати їх поруч
дешевше, ніж вимагати завантаження перед кожною перезбіркою.
